...
const apiDetailsData: Record<string, any> = {
  ...
  'Aircraft Region API': {
    ...
    version: 'v1.1',
    endpoints: ['GET /aircraft/regions', 'GET /aircraft/regions/:id'],
    tags: ['Aircraft'],
    provider: {
      name: 'Aircraft Region API',
      system: 'aircraft-system',
  ...
  'Booking Management API': {
    ...
    version: 'v1.1',
    endpoints: ['GET /bookings', 'POST /bookings', 'PUT /bookings/:id', 'DELETE /bookings/:id'],
    tags: ['Ticket'],
    provider: {
      name: 'Booking Management API',
      system: 'booking-system',
  ...
  'Loyalty Program API': {
    ...
    version: 'v1.1',
    endpoints: ['GET /loyalty', 'POST /loyalty/points', 'GET /loyalty/rewards'],
    tags: ['Client'],
    provider: {
      name: 'Loyalty Program API',
      system: 'client-system',
  ...
  'Flight Status API': {
    ...
    version: 'v1.1',
    endpoints: ['GET /flights/status', 'GET /flights/status/:id'],
    tags: ['Ticket'],
    provider: {
      name: 'Flight Status API',
      system: 'airline-system',
  ...
  'Client Registration API': {
    ...
    version: 'v1.1',
    endpoints: ['POST /clients/register', 'PUT /clients/:id', 'GET /clients/:id'],
    tags: ['Client'],
    provider: {
      name: 'Client Registration API',
      system: 'client-system',
